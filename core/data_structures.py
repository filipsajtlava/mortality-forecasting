...
class MortalityData:
    ...
    def split_by_year(
            ...
            overlap: bool = False, 
            verbose: bool = True
        ) -> tuple["MortalityData", "MortalityData"]:
        ...
        overlap, optional
            If set to True, the last year of the training set will be the same as the first year of the testing set.
        verbose, optional
        ...
        return (
            MortalityData(data=train_df, overlap=overlap), 
            MortalityData(data=test_df, overlap=overlap)
        )